					...
					<div class="modal-body">
						<div class="container-fluid">
							...
							<form id="refrom" action="" method="post">
									...
									<div class="input-group input-reg" <?php if($Tconfig["emailclick"]==0 ){echo 'style="display:none"';}?>>
										<input type="text" class="form-control code" name="code" placeholder="邮箱验证码" <?php if($Tconfig["emailclick"]== 0 ){echo 'value="0"';}?>>
